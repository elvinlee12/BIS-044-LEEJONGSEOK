...
df$Title <- replace(df$Title, df$Title=="Justice of Peace(s)", "Justice of the Peace")
df$Title <- replace(df$Title, df$Title=="Justice of Peace, Parishwide", "Justice of the Peace")
